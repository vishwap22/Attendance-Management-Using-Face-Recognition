    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='K:\AMS\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"K:\AMS\Attendance\Manually Attendance-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"K:\AMS\Attendance-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'root' :
            if password == 'rootuser123':
                ...
                cs = 'K:\AMS\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
